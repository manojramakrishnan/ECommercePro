...
import com.shopeasy.core.constants.MeasureUnit;
import com.shopeasy.core.model.ManagerEntity;
import com.shopeasy.core.model.reference.Country;
import com.shopeasy.core.model.reference.Currency;
import com.shopeasy.core.model.reference.Language;
import com.shopeasy.core.model.reference.Zone;
import com.shopeasy.core.utils.CloneUtils;

@Entity
@Table(name = "MERCHANT_STORE",
	indexes = @Index(columnList = "LINEAGE"))
public class MerchantStore extends ManagerEntity<Integer,MerchantStore> implements Auditable {
